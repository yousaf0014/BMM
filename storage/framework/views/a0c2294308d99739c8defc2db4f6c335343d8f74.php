...
<?php $__env->startSection('css'); ?>
  <link href="<?php echo asset('plugins/flatpickr/flatpickr.css'); ?>" rel="stylesheet" type="text/css" />
<?php $__env->stopSection(); ?>
<?php $__env->startSection('scripts'); ?>
<script src="<?php echo asset('plugins/flatpickr/flatpickr.js'); ?>"></script>
...
<script>
    ...
    function  loadReport(){
        ...
        $.ajax({
          method: "GET",
          url: "<?php echo e(url('attendanceAjax')); ?>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/bmmlatest/resources/views/Home/clientdashboardBuilding.blade.php ENDPATH**/ ?>