        ...
        <ul class="navbar-item flex-row ml-auto">
            ...
            <li class="nav-item dropdown user-profile-dropdown  order-lg-0 order-1">
                ...
                <div class="dropdown-menu position-absolute e-animated e-fadeInUp" aria-labelledby="userProfileDropdown">
                    <?php if(Session::has('whois')){ ?>
                    <div class="user-profile-section">                            
                        <div class="media mx-auto">
                            <img src="<?php echo asset('img/90x90.jpg'); ?>" class="img-fluid mr-2" alt="avatar">
                            <div class="media-body">
                                <a href="<?php echo e(url('backToOrignal')); ?>"><h5><?php echo  getName(Session::get('whois')) ?></h5></a>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
                    <div class="user-profile-section">                            
                        <div class="media mx-auto">
                            <img src="<?php echo asset('img/90x90.jpg'); ?>" class="img-fluid mr-2" alt="avatar">
                            <div class="media-body"> <?php if(Session::has('whois')){ echo 'Act As:'; } ?>
                                <h5><?php 
                                        $userSession = Auth::user();
                                        echo  $userSession->first_name.' '.$userSession->last_name; ?></h5>
                            </div>
                        </div>
                    </div>
                    <div class="dropdown-item">
...
</div><?php /**PATH /opt/lampp/htdocs/bmmlatest/resources/views/layouts/admin/header.blade.php ENDPATH**/ ?>