    ...
    <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
        <div class="row">
            ...
            <div class="col-lg-12 col-12  layout-spacing">
                <form id="searchCompanies" name="searchSs" action="<?php echo e(url('/ads')); ?>">
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-2">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ads-add')): ?>
                                    <a href="<?php echo e(url('/ads/create/')); ?>" class="btn btn-success btn-sm">
                                        <span class="icon text-white-50">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-plus"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="12" y1="18" x2="12" y2="12"></line><line x1="9" y1="15" x2="15" y2="15"></line></svg>
                                        </span>
                                        <span class="text">Add Ad</span>
                                    </a>
                                    <?php endif; ?>
                                </div>
                            </div>
                                            ...
                                            <table class="table table-bordered table-hover mb-4">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ads-show')): ?>
                                                        <th class="text-center">Pre-View</th>
                                                        <?php endif; ?>
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ads-edit')): ?>
                                                        <th class="text-center">Edit</th>
                                                        <?php endif; ?>
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ads-delete')): ?>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php $__currentLoopData = $ads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><span ><img width="200px" src="<?php echo e(url($row->url)); ?>" width="200px">  </span></td>
                                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ads-show')): ?>
                                                            <td class="text-center">
                                                                <a href="<?php echo e(url('/ads/'.$row->id.'/')); ?>" title="View">
                                                                    <div class="icon-container">
                                                            ...
                                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ads-edit')): ?>
                                                            <td>
                                                                <a href="<?php echo e(url('/ads/'.$row->id.'/edit')); ?>" title="Edit Content" >
                                                                    <div class="icon-container">
                                                            ...
                                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ads-delete')): ?>
                                                            <td>
                                                                <?php echo Form::open(array('url' => '/ads/' . $row->id ,'id'=>'delete_'.$row->id,'class' => 'pull-right')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/bmmlatest/resources/views/Ads/index.blade.php ENDPATH**/ ?>