...
<head>
  ...
  <?php
    ...
    <?php } ?>
  <title><?php echo !empty($title_for_layout) ? $title_for_layout:'TurboAnchor.com|Bmm'; ?></title>
  <link rel="icon" type="image/x-icon" href="<?php echo asset('fav.png');; ?>"/>
  <link href="<?php echo asset('css/loader.css'); ?>" rel="stylesheet" type="text/css" />
  <script src="<?php echo asset('js/loader.js'); ?>"></script>
  ...
  <link href="<?php echo asset('css/perfect-scrollbar.css'); ?>" rel="stylesheet" type="text/css" />
...
<body class="alt-menu sidebar-noneoverflow">
  ...
  <!-- BEGIN GLOBAL MANDATORY SCRIPTS -->
    ...
    <script src="<?php echo asset('bootstrap/js/popper.min.js'); ?>"></script>
    <script src="<?php echo asset('bootstrap/js/bootstrap.min.js'); ?>"></script>
    <script src="<?php echo asset('js/perfect-scrollbar.min.js'); ?>"></script>
...
<?php /**PATH /opt/lampp/htdocs/bmmlatest/resources/views/layouts/admin/app.blade.php ENDPATH**/ ?>