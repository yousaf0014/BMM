    ...
    <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
        <div class="row">
            ...
            <div class="col-lg-12 col-12  layout-spacing">
                <form id="searchCompanies" name="searchSs" action="{{url('/roles')}}">
                                                    ...
                                                    @foreach ($roles as $row)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="{{url('/roles/'.$row->id.'/')}}" title="View">
                                                                    <div class="icon-container">
                                                            ...
                                                            <td>
                                                                @can('role-edit')
                                                                <a href="{{url('/roles/'.$row->id.'/edit')}}" title="Edit Content" >
                                                                    <div class="icon-container">
                                                            ...
                                                            <td>
                                                                @can('role-delete')
                                                                {!! Form::open(array('url' => '/roles/' . $row->id ,'id'=>'delete_'.$row->id,'class' => 'pull-right')) !!}
