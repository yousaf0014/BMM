    ...
    <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
        <div class="row">
            ...
            <div class="col-lg-12 col-12  layout-spacing">
                <form id="searchCompanies" name="searchSs" action="{{url('/ads')}}">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($ads as $row)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><span ><img width="200px" src="{{url($row->url)}}" width="200px">  </span></td>
                                                            @can('ads-show')
                                                            <td class="text-center">
                                                                <a href="{{url('/ads/'.$row->id.'/')}}" title="View">
                                                                    <div class="icon-container">
                                                            ...
                                                            @can('ads-edit')
                                                            <td>
                                                                <a href="{{url('/ads/'.$row->id.'/edit')}}" title="Edit Content" >
                                                                    <div class="icon-container">
                                                            ...
                                                            @can('ads-delete')
                                                            <td>
                                                                {!! Form::open(array('url' => '/ads/' . $row->id ,'id'=>'delete_'.$row->id,'class' => 'pull-right')) !!}
